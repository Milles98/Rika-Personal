    ...
    return (
        ...
        >
            <div className="flex items-center p-4 text-green-800 rounded-lg bg-green-50 dark:bg-black dark:text-green-400">
                ...
                <div className="ms-3 text-xs sm:text-sm md:text-base font-bold">
                    {message}
                </div>
                <button
                    type="button"
                ...
                >
                    ...
                    <svg className="w-3 h-3 sm:w-4 sm:h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
