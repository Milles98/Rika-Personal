...
export const ShippingProvider = ({ children }) => {
    ...
    const getServicePoints = async (formData) => {
        ...
        try {
            const response = await fetch(`https://shoppingprovider-d5dgaegpcmgugphy.westeurope-01.azurewebsites.net/Shipping/ServicePoints?postalCode=${postalCode}&numberOfServicePoints=4`);
            if (!response.ok) {
